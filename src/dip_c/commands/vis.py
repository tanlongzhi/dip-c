...
def vis(argv):
    ...
    from pdbx import PdbxWriter, DataCategory, DataContainer
    ...
    if g3d_data.num_g3d_particles() == 0:
        sys.stderr.write("[E::" + __name__ + "] input file has no particles\n")
        return 1
    ...
    aCat.append_attribute("group_PDB")
    aCat.append_attribute("type_symbol")
    aCat.append_attribute("id")
    aCat.append_attribute("label_asym_id")
    aCat.append_attribute("label_comp_id")
    aCat.append_attribute("label_seq_id")
    aCat.append_attribute("label_atom_id")
    aCat.append_attribute("Cartn_x")
    aCat.append_attribute("Cartn_y")
    aCat.append_attribute("Cartn_z")
    aCat.append_attribute("B_iso_or_equiv")

    sCat = DataCategory("struct_conn")
    sCat.append_attribute("id")
    sCat.append_attribute("conn_type_id")
    sCat.append_attribute("ptnr1_label_asym_id")
    sCat.append_attribute("ptnr1_label_comp_id")
    sCat.append_attribute("ptnr1_label_seq_id")
    sCat.append_attribute("ptnr1_label_atom_id")
    sCat.append_attribute("ptnr2_label_asym_id")
    sCat.append_attribute("ptnr2_label_comp_id")
    sCat.append_attribute("ptnr2_label_seq_id")
    sCat.append_attribute("ptnr2_label_atom_id")
