...
import gzip
import copy
from dip_c.classes import Haplotypes, Leg, string_to_leg, G3dData, file_to_g3d_data
import numpy as np
...
def pd(argv):
    ...
    for leg_file_1_line in open(leg_file_1_name, "r"):
    ...
    for leg_file_2_line in open(leg_file_2_name, "r"):
