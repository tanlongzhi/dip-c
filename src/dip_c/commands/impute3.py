...
import gzip
import copy
from dip_c.classes import Haplotypes, ConData, file_to_con_data, Leg, Par, ParData, G3dData, file_to_g3d_data
...
def impute3(argv):
    ...
    # read 3DG file
    g3d_data = file_to_g3d_data(open(g3d_file_name, "r"))
