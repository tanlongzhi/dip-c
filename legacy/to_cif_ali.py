...
for inputBedgraphFileLine in inputBedgraphFile:
    ...
    bFactorData[(inputChr, int(inputBedgraphFileLineData[1]))] = float(inputBedgraphFileLineData[2])
...
for inputPdbLine in inputPdbFile:
    ...
    inputBFactor = -1.0
    if (inputChr, inputPosValue) in bFactorData:
        inputBFactor = bFactorData[(inputChr, inputPosValue)]
